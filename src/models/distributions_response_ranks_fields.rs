...
pub struct DistributionsResponseRanksFields {
    /// name
    ...
    pub data_type_modifier: Option<String>,
    /// format
    #[serde(rename = "format", skip_serializing_if = "Option::is_none")]
    pub format: Option<String>,
}

impl DistributionsResponseRanksFields {
    pub fn new() -> DistributionsResponseRanksFields {
