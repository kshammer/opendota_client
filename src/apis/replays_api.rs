...
/// struct for typed errors of method [`replays_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReplaysGetError {
...
pub async fn replays_get(configuration: &configuration::Configuration, match_id: i32) -> Result<Vec<crate::models::InlineResponse20033>, Error<ReplaysGetError>> {
    ...
    let local_var_uri_str = format!("{}/replays", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReplaysGetError> = serde_json::from_str(&local_var_content).ok();
