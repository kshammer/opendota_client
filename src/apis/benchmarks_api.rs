...
/// struct for typed errors of method [`benchmarks_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum BenchmarksGetError {
...
pub async fn benchmarks_get(configuration: &configuration::Configuration, hero_id: &str) -> Result<crate::models::InlineResponse20023, Error<BenchmarksGetError>> {
    ...
    let local_var_uri_str = format!("{}/benchmarks", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BenchmarksGetError> = serde_json::from_str(&local_var_content).ok();
